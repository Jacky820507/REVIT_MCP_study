...
| MCP Tools | 共用 68 個工具 | 共用 68 個工具 | 共用 68 個工具 |
...
| `MCP/Core/CommandExecutor.cs` | Central command dispatcher (68 commands), largest file |
...
| `MCP-Server/src/tools/` | Tool definitions (68 tools, 分 14 個模組) |
